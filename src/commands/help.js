...
const commands = [
  ...
  { name: '/slots apuesta', description: 'Tragaperras con animación de reels girando.' },
  { name: '/ruleta apuesta tipo', description: 'Ruleta: rojo, negro, verde o número exacto.' },
  { name: '/blackjack apuesta', description: 'Blackjack contra el dealer con botones interactivos.' },
  { name: '/poker apuesta', description: 'Video Poker. Par de J o mejor para ganar.' },
  { name: '/crash apuesta', description: 'Retírate antes de que el multiplicador explote.' },
  { name: '/mines apuesta [minas]', description: 'Buscaminas casino. Abre 💎, evita 💣.' },
  { name: '/dados apuesta tipo', description: 'Dados: bajo (2-6), siete (7) o alto (8-12).' },
  { name: '/coinflip apuesta lado', description: 'Cara o cruz. Simple y directo.' },
  { name: '/wheel apuesta', description: 'Rueda de la fortuna. Multiplicadores de x0 a x10.' },
